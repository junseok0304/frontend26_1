<script setup>
import { ref } from 'vue';
const {title="카운터", step=1, value=5} = defineProps(['title','step','value']);
...
background-color: #e8ffe8; border: 1px solid #aca; }
p { font-size: 20pt; text-align: center; margin: 0; }
button { padding: 0.7em 1.5em; margin: 5px; }
</style>